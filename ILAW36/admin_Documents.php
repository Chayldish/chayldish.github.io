                ...
                <div class="modal-dialog modal-md" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title upload-form-heading" id="upload-form-heading">Upload New Image</h5>
                            ...
                            <form action="admin_Actions.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row justify-content-center">
                                            ...
                                            <div class="col-md-12 form-group ">
                                                <label for="description_field" class="upload-form-label" >Image Description</label>
                                                <textarea class="form-control upload-form-field" placeholder="Information about the Image" id="description_field" name="description_field" rows="9" required></textarea>
                                            </div>
                                        ...
                                        <div class="form-row justify-content-center">
                                            ...
                                            <div class="col-md-12 form-group text-center">
                                                <input type="file" name="myfile" accept="image/*" id="input_file" required>
                                            </div>
                                ...
                                <div class="form-row justify-content-center">                           
                                    <div class="col-md- form-group text-center">
                                        <label for="document_date_time_field" class="upload-form-label " >Date and Time of Image Upload</label>
            ...
            <div class="modal fade" id="delete-document-modal" tabindex="-1" role="dialog" aria-labelledby="delete-document-modal" aria-hidden="true">
                ...
                <div class="modal-dialog modal-md" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title delete-document-heading" id="delete-document-heading">Delete Image</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                            ...
                            <form action="admin_Actions.php" method="post">
                                ...
                                <div class="form-row justify-content-center text-center">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label for="delete_document_id_field" class="delete-document-form-label" >IMAGE ID</label>
                                ...
                                <div class="form-row justify-content-center">
                                    ...
                                    <div class="col-md-12 form-group ">
                                        <label for="delete_document_title_field" class="delete-document-form-label" >Image Name</label>
                                ...
                                <div class="form-row justify-content-center">
                                    ...
                                    <div class="col-md-12 form-group ">
                                        <label for="delete_document_body_field" class="delete-document-form-label" >Image Description</label>
                                        <textarea readonly class="form-control delete-document-form-field" placeholder="Image Description" id="delete_document_body_field" name="delete_document_body_field" rows="9" required></textarea>
                                    </div>
                                ...
                                <div class="form-row justify-content-center">
                                    ...
                                    <div class="col-md-6 form-group text-center">
                                        <label for="delete_document_date_time_field" class="delete-post-document-label " >Image Uploaded on</label>
                                        <div class="input-group date" id="datetimepicker">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col text-right mt-2 mb-2">
                                        <button type="submit" class="btn btn-danger delete-post-btn" id="btn_delete_document" name="btn_delete_document">DELETE IMAGE</button>                                   
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img id="view-image" src="" alt="Selected Image" class="img-fluid">
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function () {
    $('#view-image-modal').on('show.bs.modal', function (e) {
        ...
        modal.find('#view-image').attr('src', imageUrl); // Set the image URL in the modal
    });
});
